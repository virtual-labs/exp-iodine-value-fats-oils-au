...
(function(){
    ...
    */
    function UserController( $mdSidenav,$mdBottomSheet,$log,$q,$scope,$element,Fullscreen,$mdToast, $animate) {
		...
		/** Change event function of add starch button */
		$scope.addStarch=function(){
			addStarchFn($scope);
		}
		...
		/** Change event function of select fat/oil dropdown */
		$scope.setFatOil=function(){
			setFatOilFn($scope);
		}
		/** Change event function of fill burette dropdown */
		$scope.fillSolution=function(){
			fillSolutionFn($scope);
		}
		/**
